...
export default function ProjectDescr() {
  // Filter Data with Params
    ...
    const FilteredData:{id:number;names:string;image:string[];webSiteDescrition:string;webSiteDescriptionpl:string;myJobpl:string;websiteAdrress:string;myJob:string;skills:string;github?:string;}|undefined = Data.find(res=>res.id === parseInt(Id))
  // Set Page Top
    useEffect(()=>{
      window.scrollTo(0,0)
    },[])
